...
const navItems: NavItem[] = [
  ...
  { href: '/admin/messages', label: 'Cảnh báo của BCN iSSAC', icon: AlertTriangle, group: 'main' },
...
export function AdminSidebar({ user, isOpen = false, onClose }: AdminSidebarProps) {
  ...
  const handleSignOut = async () => {
    ...
    document.cookie = 'issac_logged_admin_title=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT'
    document.cookie = 'issac_logged_admin_email=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT'
