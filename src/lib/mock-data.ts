...
export const MOCK_CANDIDATES = [
  ...
  },
  {
    ...
    profiles: {
      ...
      gender: 'Nữ',
      cv_url: '',
      facebook_url: 'https://facebook.com/thuylinh.is24',
      gpa: 3.45,
      bio: 'Tân sinh viên K24 hào hứng với các hoạt động CLB iSSAC. Đã đăng ký tài khoản sớm và cập nhật xong Phần 1 cá nhân.',
    },
  ...
  },
  {
    ...
    profiles: {
      ...
      email: 'quanghuy.vnuis@gmail.com',
      student_id: '23070119',
      phone: '0978654321',
      university: 'Trường Quốc tế - ĐHQGHN (VNU-IS)',
      major: 'Tin học và Kỹ thuật máy tính',
      cohort: 'K23',
      gender: 'Nam',
      cv_url: 'https://drive.google.com/sample_cv_huy',
      facebook_url: 'https://facebook.com/quanghuy.vnu',
      gpa: 3.20,
      bio: 'Yêu thích thiết kế đồ họa và quản trị hệ thống media. Đang soạn dở đơn Ban Truyền thông chưa gửi.',
    },
    departments: { name: 'Ban Truyền thông (Nháp)', slug: 'truyen-thong' },
    evaluator: null,
    evaluation_data: null,
    candidate_rankings: null,
  },
  {
    ...
    profiles: {
      ...
      email: 'maianh.issac26@vnu.edu.vn',
      student_id: '24070205',
      phone: '0934567890',
      university: 'Trường Quốc tế - ĐHQGHN (VNU-IS)',
      ...
      gender: 'Nữ',
      cv_url: '',
      facebook_url: 'https://facebook.com/maianh.mkt',
      gpa: 3.60,
      bio: 'Đã đăng ký tài khoản, hoàn thiện Phần 1 và 2, đang chờ Ban Chủ nhiệm công bố bộ câu hỏi.',
    },
    departments: { name: 'Chưa chọn ban', slug: 'unassigned' },
    evaluator: null,
    evaluation_data: null,
